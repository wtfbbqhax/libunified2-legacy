 ...
 *      void
 */
void PrintPacketData(uint8_t *data, int length)
{
    int i, x, j, c;
    int w = 0;
...
/* Function: PrintPacketHeader
 *
 * Purpose: Print the fields of a Unified2Packet to stdout
 *
 * Arguements:
 *      Unified2Packet *
 *
 ...
 *      void
 */
void PrintPacketRecord(Unified2Packet *packet)
{
    printf("Sensor id           %d\n", packet->sensor_id);
    printf("Event id            %d\n", packet->event_id);
 ...
 *      void
 */
void PrintEventRecord(Unified2Event *event)
{
 ...
 *      void
 */
void PrintEventv2Record(Unified2Event_v2 *event)
{
 ...
 *      void
 */
void PrintEvent6Record(Unified2Event6 *event)
{
 ...
 *      void
 */
void PrintEvent6v2Record(Unified2Event6_v2 *event)
{
    char ip_source[INET6_ADDRSTRLEN+1];
    char ip_destination[INET6_ADDRSTRLEN+1];
    inet_ntop(AF_INET6, &event->ip_source, ip_source, INET6_ADDRSTRLEN);
 ...
 *      void
 */
HRESULT PrintRecord(Unified2Entry *entry) {
